...
Route.prototype = {
  ...
  resolve: function (params) {
    ...
    params = params || [];
    //XXX change this api, it's confusing!
    query = params.query;
  ...
  url: function (params) {
    //XXX don't use Meteor.absoluteUrl here. use Location.origin()
  ...
  getController: function (path, options) {
    ...
    if (handler = this.handler) {
      controller = new RouteController(this, path, params, options);
    ...
    if (this.controller) {
      ...
      controller = new controllerClass(this, path, params, options);
      return controller;
    }
    ...
    return new RouteController(this, path, params, options);
  }
};
