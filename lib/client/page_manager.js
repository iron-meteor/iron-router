// LEGACY - LOOK AT PAGE.JS FOR NEW UI STUFF
...
PageManager.prototype = {
  ...
  _renderTemplate: function (key) {
    ...
    //XXX how to achieve isolation Meteor UI
  ...
  //XXX Meteor UI change
  renderLayout: function () {
    var self = this;

    //XXX How do we isolate in Meteor UI?
