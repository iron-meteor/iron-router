...
_.extend(IronRouter.prototype, {
  ...
  start: function () {
    ...
    //with the browser?
    //XXX this is getting called before our app code runs
    Meteor.startup(function () {
  ...
  //XXX allow passing a route name here
