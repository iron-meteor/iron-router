IronRouter = Utils.extend(IronRouter, {
  setUIManager: function (fn) {
    if (this.isRendered)
      throw new Error("You can only call setUIManager before the router is rendered");
  ...
  constructor: function (options) {
    ...
    this.setUIManager(function () {
      // the default ui manager
      return new SparkUIManager;
    });
  ...
  setLayout: function (layout) {
    this._ui.template(layout);
  },

  setTemplate: function (template, to) {
    this._ui.setRegion(to, template);
  },
  ...
  //XXX remove
  getData: function () {
    return this._ui.data();
  },

  data: function (value) {
    return this._ui.data(value);
  },
