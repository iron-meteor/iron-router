...
ClientRouter = Utils.extend(IronRouter, {
  ...
  constructor: function (options) {
    ...
    self.pageController = new PageController;
  ...
  setLayout: function (layout) {
    this.pageController.setLayout(layout);
  },

  setTemplate: function (template, to) {
    this.pageController.setTemplate(template, to);
  },

  setData: function (data) {
    this.pageController.setData(data);
  },
  ...
  //XXX Page/ControllerManager needs to know when the run has started and
  //complete, so it can compare previous renderings to current renderings and
  //clear the previous renderings.
  //XXX Set the dataContext of the manager each time.
  ...
  render: function () {
    ...
    return this.pageController.renderLayout();
  },
