...
ClientRouter = RouterUtils.extend(IronRouter, {
  ...
  /**
   * Returns an annotated or regular html string with the Router's layout. This
   * method also sets up the 'yield' helper on the layout. This is so that the
   * yield helper has a reference to the router through the closure.
   *
   * @api public
   * @returns {String}
   */
...
/**
 * The main Router object that clients will deal with
 *
 * @api public
 */
