RouteController = Utils.extend(IronRouteController, {
  ...
  setPageManager: function (pageApi) {
    this._page = pageApi;
  },
  ...
  getData: function () {
    this._page && this._page.getData();
  },

  setData: function (data) {
    this._page && this._page.setData(data);
  },
  ...
  render: function (template, options) {
    ...
    self._page && self._page.setTemplate(template, to);
  },

  setLayout: function (template) {
    this._page && this._page.setLayout(template);
  },
  ...
  runActionWithHooks: function () {
    ...
    var onDataReady = function () {
      ...
      if (data !== false) {
        self._page && self._page.setData(data);
      }
