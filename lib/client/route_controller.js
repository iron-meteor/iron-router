...
var autoClearUnusedRegionsHook = function () {
...
RouteController = Utils.extend(IronRouteController, {
  ...
  setData: function (data) {
    var self = this;
    var boundData = function () {
      return _.isFunction(data) ? data.call(self) : data;
    };
    this.router && this.router.setData(boundData);
  },
