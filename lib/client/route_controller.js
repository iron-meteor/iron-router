RouteController = Utils.extend(IronRouteController, {
  ...
  runActionWithHooks: function () {
    ...
    var onDataReady = function () {
      ...
      //XXX The idea here was you could tell the router that you don't want to
      //set the data context for the route, thus preventing a teardown of the
      //template that relies on the data context.
      if (data !== false) {
