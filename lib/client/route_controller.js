...
RouteController = Utils.extend(IronRouteController, {
  ...
  subscribe: function (subscriptionName) {
    return this.router.subscriptions.add(this, arguments);
  },
  ...
  run: function () {
    ...
    this.runHooks('before', [
      function() {
        this._waitList.push(this.router.subscriptions.getReadyHandler());
      },
