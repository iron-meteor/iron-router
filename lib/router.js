IronRouter = function (options) {
  ...
  this.setNameConverter('Template', 'camel');
  this.setNameConverter('RouteController', 'class');
...
IronRouter.prototype = {
  ...
  load: function(hook, options) {
    return this.onRun(hook, options);
  },

  // legacy
  before: function(hook, options) {
    return this.onBeforeAction(hook, options);
  },
  
  // legacy
  after: function(hook, options) {
    return this.onAfterAction(hook, options);
  },
  
  // legacy
  unload: function(hook, options) {
    return this.onStop(hook, options);
  },
