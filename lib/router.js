var constructRoute = function (router, name, options) {
  var className = Utils.classify(name) + 'Route';
  var RouteKlass = Utils.resolveValue(className) || Route;
  options = _.extend({}, router.options, options || {});
  return new RouteKlass(router, name, options);
};
...
IronRouter.prototype = {
  ...
  route: function (name, options) {
    ...
    if (options instanceof Route)
      ...
      route = constructRoute(this, name, options);
